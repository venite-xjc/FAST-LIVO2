...
public:
  ...
  rclcpp::Publisher<sensor_msgs::msg::CameraInfo>::SharedPtr pubCameraInfo;  // 相机内参publisher
  rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr pubCameraExtrinsics;  // 相机外参publisher
